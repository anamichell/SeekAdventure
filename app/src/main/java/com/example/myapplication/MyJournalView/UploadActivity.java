...
// uploads data to Firebase storage and database
...
public class UploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Code sets up a listener to handle the result of an activity (uploading image)
        // and performs an action based on if it was successful or not
        ...
        // Create a calendar view for date data
    ...
    public void saveData(){
        ...
        // Creates a storage reference, when it is in the process of being created then
        ...
        // if image uploads then it will go into the database, if not error will occur
