...
// Adapter class for a RecyclerView that displays a list of DestinationItems
public class MyDestinationAdapter extends RecyclerView.Adapter<MyDestinationAdapter.MyViewHolder>{
    ...
    // Binds the data to the views of the layout
    @Override
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        // Viewholder allows us to minimize the number of findViewByIf() calls by caching the results in a holder object
